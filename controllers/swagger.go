...
import (
	"context"
	"goa-context-sample/swaggerassets"
	"net/http"
	"path/filepath"
	"strings"
...
func MountSwaggerController(service *goa.Service, ctrl *SwaggerController) {
	...
	h = GoaGobinAssetHandler("/swagger.json", "swagger/swagger.json")
	service.Mux.Handle("GET", "/swagger.json", ctrl.MuxHandler("serve", h, nil))
	service.LogInfo("mount", "ctrl", "Swagger", "files", "swagger/swagger.json", "route", "GET /swagger.json")

	h = GoaGobinAssetHandler("/swaggerui/*filepath", "swaggerui/dist")
	...
	h = GoaGobinAssetHandler("/swaggerui/", "swaggerui/dist/index.html")
